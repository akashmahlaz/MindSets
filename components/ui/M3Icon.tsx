...
const ICON_MAP = {
  ...
  "arrow-up": { mci: "arrow-up", ion: "arrow-up" },
  "arrow-down": { mci: "arrow-down", ion: "arrow-down" },
  "chevron-right": { mci: "chevron-right", ion: "chevron-forward" },
  "chevron-forward": { mci: "chevron-right", ion: "chevron-forward" },
  ...
  "man": { mci: "human-male", ion: "man" },
  "man-outline": { mci: "human-male", ion: "man-outline" },
  "woman": { mci: "human-female", ion: "woman" },
  "woman-outline": { mci: "human-female", ion: "woman-outline" },
  ...
  "mail": { mci: "email", ion: "mail" },
  "mail-outline": { mci: "email-outline", ion: "mail-outline" },
  ...
  "create": { mci: "pencil", ion: "create" },
  "create-outline": { mci: "pencil-outline", ion: "create-outline" },
  "delete": { mci: "delete", ion: "trash" },
  "delete-outline": { mci: "delete-outline", ion: "trash-outline" },
  "trash": { mci: "delete", ion: "trash" },
  "trash-outline": { mci: "delete-outline", ion: "trash-outline" },
  ...
  "checkmark": { mci: "check", ion: "checkmark" },
  "checkmark-circle": { mci: "check-circle", ion: "checkmark-circle" },
  ...
  "information-circle": { mci: "information", ion: "information-circle" },
  "information-circle-outline": { mci: "information-outline", ion: "information-circle-outline" },
  ...
  "lock-closed": { mci: "lock", ion: "lock-closed" },
  "lock-closed-outline": { mci: "lock-outline", ion: "lock-closed-outline" },
  "eye": { mci: "eye", ion: "eye" },
  ...
  "log-out": { mci: "logout", ion: "log-out" },
  "log-out-outline": { mci: "logout", ion: "log-out-outline" },
  ...
  "newspaper": { mci: "newspaper", ion: "newspaper" },
  "newspaper-outline": { mci: "newspaper-variant-outline", ion: "newspaper-outline" },
  "book": { mci: "book", ion: "book" },
  "book-outline": { mci: "book-outline", ion: "book-outline" },
  "trending-up": { mci: "trending-up", ion: "trending-up" },
  "trending-down": { mci: "trending-down", ion: "trending-down" },
  "analytics": { mci: "chart-line", ion: "analytics" },
  "analytics-outline": { mci: "chart-line-variant", ion: "analytics-outline" },
  "ribbon": { mci: "ribbon", ion: "ribbon" },
  "ribbon-outline": { mci: "ribbon-outline", ion: "ribbon-outline" },
  "trophy": { mci: "trophy", ion: "trophy" },
  "trophy-outline": { mci: "trophy-outline", ion: "trophy-outline" },
  "flash-off": { mci: "flash-off", ion: "flash-off" },
  "flash-off-outline": { mci: "flash-off-outline", ion: "flash-off-outline" },
  
  // Brand logos
  "logo-apple": { mci: "apple", ion: "logo-apple" },
  "logo-google": { mci: "google", ion: "logo-google" },
  "logo-facebook": { mci: "facebook", ion: "logo-facebook" },
} as const;
