...
import { ActivityIndicator, Keyboard, KeyboardAvoidingView, Platform, ScrollView, StatusBar, Text, TouchableWithoutFeedback, View } from 'react-native';
          ...
          >
            <View style={{ maxWidth: 480, width: '100%', alignSelf: 'center' }}>
              ...
              <View className="items-center mb-8">
                ...
                <P className="mb-2 text-center">Sign in to continue your mental health journey with <Text className="text-primary font-semibold">MindConnect</Text></P>
              </View>
              {/* Form Section */}
              <Card style={{ elevation: 4, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 12, borderRadius: 16 }}>
                ...
                <CardContent className="space-y-6">
                  ...
                  {/* Sign In Button */}
                  <Button onPress={handleEmailSignIn} disabled={isLoading} className="w-full h-12 mt-2">
