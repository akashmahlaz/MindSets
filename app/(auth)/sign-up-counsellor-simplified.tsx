          ...
          >
            <View style={{ maxWidth: 480, width: "100%", alignSelf: "center" }}>
              ...
              <View className="items-center mb-8">
                ...
                >
                  <Ionicons name="medical" size={32} color={Theme.colors.secondary} />
                </View>
                ...
                <Text className="text-center mt-2" style={{ color: Theme.colors.text, opacity: 0.7 }}>
                  Join Mind Sets as a Counsellor
                </Text>
              </View>
              ...
              >
                ...
                <CardContent className="space-y-5 pt-6">
                  ...
                  <View className="space-y-2">
                    <Label className="font-medium ml-1" style={{ color: Theme.colors.text }}>Professional Email</Label>
                    <Input
                  ...
                  <View className="p-4 rounded-xl" style={{ backgroundColor: Theme.colors.background }}>
                    ...
                    <Text className="text-sm" style={{ color: Theme.colors.text, opacity: 0.7 }}>
                      Your application will be reviewed by our team. You may be
                ...
                <CardContent className="pb-8">
                  <View className="flex-row justify-between mt-2 gap-4">
                    ...
                    <Button
                      ...
                      style={{ 
                        flex: 2, 
                        backgroundColor: isFormValid ? Theme.colors.secondary : Theme.colors.accent,
                        height: 56,
                        borderRadius: 16
                      }}
                    >
                      {loading ? (
                        ...
                        <Text className="font-bold text-lg" style={{ color: Theme.colors.text }}>Submit Application</Text>
                      )}
                    </Button>
                  </View>
                </CardContent>
